...
class RebaExport implements FromArray, ShouldAutoSize, WithStyles, WithEvents, WithTitle, WithCharts
{
    ...
    public function array(): array
    {
        ...
        $rows[] = ['REPORTE DE EVALUACIÓN REBA'];
        $rows[] = [''];
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('A21:D22')->getFill()->setFillType(Fill::FILL_SOLID)
                    ->getStartColor()->setRGB('E2E8F0');

                $sheet->getStyle('A1:D200')->getAlignment()->setVertical(Alignment::VERTICAL_CENTER);
    ...
    {
        $label = [
            new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_STRING, 'REBA!$B$15', null, 1),
        ];

        $categories = [
            new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_STRING, 'REBA!$A$16:$A$19', null, 4),
        ];

        $values = [
            new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_NUMBER, 'REBA!$B$16:$B$19', null, 4),
        ];
        ...
        $title = new Title('Puntuaciones REBA');

        $chart = new Chart('reba_chart', $title, $legend, $plotArea);
