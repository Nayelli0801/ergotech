...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $riesgoPorcentaje = [
            'Bajo' => $totalRiesgos > 0 ? round(($riesgos['Bajo'] / $totalRiesgos) * 100, 1) : 0,
            'Medio' => $totalRiesgos > 0 ? round(($riesgos['Medio'] / $totalRiesgos) * 100, 1) : 0,
            'Alto' => $totalRiesgos > 0 ? round(($riesgos['Alto'] / $totalRiesgos) * 100, 1) : 0,
            'Muy alto' => $totalRiesgos > 0 ? round(($riesgos['Muy alto'] / $totalRiesgos) * 100, 1) : 0,
            'Inapreciable' => $totalRiesgos > 0 ? round(($riesgos['Inapreciable'] / $totalRiesgos) * 100, 1) : 0,
        ];
