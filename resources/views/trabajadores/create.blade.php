    ...
    <div class="max-w-5xl mx-auto py-8 px-6">
        <div class="bg-white shadow-lg rounded-2xl border border-gray-200 overflow-hidden">
            <div class="bg-sky-600 text-white px-6 py-4">
                ...
                <p class="text-sm text-blue-100">Registra un nuevo trabajador</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('trabajadores.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="apellido_paterno" value="{{ old('apellido_paterno') }}" class="w-full rounded-lg border-gray-300">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Apellido materno</label>
                        <input type="text" name="apellido_materno" value="{{ old('apellido_materno') }}" class="w-full rounded-lg border-gray-300">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="edad" value="{{ old('edad') }}" class="w-full rounded-lg border-gray-300">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Estatura</label>
                        <input type="number" step="0.01" name="estatura" value="{{ old('estatura') }}" class="w-full rounded-lg border-gray-300">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Peso</label>
                        <input type="number" step="0.01" name="peso" value="{{ old('peso') }}" class="w-full rounded-lg border-gray-300">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Antigüedad</label>
                        <input type="number" step="0.01" name="antiguedad" value="{{ old('antiguedad') }}" class="w-full rounded-lg border-gray-300">
                    </div>
                    ...
                    <div class="md:col-span-2 flex gap-3 pt-2">
                        <button type="submit" class="bg-sky-600 hover:bg-sky-700 text-white px-5 py-2.5 rounded-lg transition">
                            Guardar
                        </button>
