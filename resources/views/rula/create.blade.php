                    ...
                    <div class="bg-sky-50 border border-sky-200 rounded-xl shadow-sm p-5">
                        ...
                        <div class="space-y-4">
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Elige la opción que más se parezca a la postura observada del brazo.</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Elige la posición del antebrazo y marca si trabaja fuera del rango normal.</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Elige la postura de la muñeca y marca si está desviada.</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Selecciona el grado de giro observado.</p>
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl shadow-sm p-5">
                        ...
                        <div class="space-y-4">
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Selecciona la postura principal del cuello y marca los ajustes si aplican.</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Selecciona la postura del tronco y marca ajustes si existen.</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <p class="text-sm text-gray-500 mb-3">Selecciona la condición de apoyo de piernas y pies.</p>
