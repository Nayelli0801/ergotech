                ...
                <form action="{{ route('empresas.store') }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="direccion" rows="4"
                                    class="w-full border rounded-lg p-2 border-gray-300"></textarea>
                            </div>
                        ...
                        <div>
                            ...
                            {{-- Vista previa --}}
                            <div class="w-full h-64 border rounded-xl bg-gray-50 flex items-center justify-center mb-4">
                            ...
                            <p class="text-xs text-gray-400 mt-2">
                                Formatos permitidos: JPG, PNG, JPEG y WEBP
                            </p>
